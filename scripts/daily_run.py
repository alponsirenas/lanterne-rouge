...
if __name__ == "__main__":
    ...
    if not os.path.exists(reasoning_log_path):
        with open(reasoning_log_path, mode='w') as file:
            file.write("day,readiness_score,activity_balance,body_temperature,hrv_balance,previous_day_activity,previous_night,recovery_index,resting_heart_rate,sleep_balance,explanation\n")
    with open(reasoning_log_path, mode='a') as file:
        file.write(f"{log['date']},{log['readiness']['score']},{log['readiness']['hrv_balance']},,,,,,,,{explanation}\n")
